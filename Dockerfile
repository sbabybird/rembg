...
COPY u2net/u2netp.onnx /root/.u2net/u2netp.onnx
COPY u2net/u2net.onnx /root/.u2net/u2net.onnx
COPY u2net/u2net_human_seg.onnx /root/.u2net/u2net_human_seg.onnx
COPY u2net/u2net_cloth_seg.onnx /root/.u2net/u2net_cloth_seg.onnx
# CMD ["copy", "/rembg/u2net/*", "~/.u2net/*"] 
